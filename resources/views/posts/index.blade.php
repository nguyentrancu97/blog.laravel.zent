        ...
        @foreach($posts as $post)
            <article>
                <div class="post-image">
                    ...
                    <div class="category"><a href="{{route('category', ['slug' => $post->category->slug])}}">{{$post->category->name}}</a></div>
                </div>
                <div class="post-text">
                    <span class="date">{{ $post->created_at }}</span>
                    <h2><a href="{{route('blog-detail', ['slug' => $post->slug])}}">{{ $post->title }}</a></h2>
                    <p class="text">
                        {!! $post->description !!}
                ...
                <div class="post-info">
                    <div class="post-by"> <a href="#">CuNTDF4</a></div>
